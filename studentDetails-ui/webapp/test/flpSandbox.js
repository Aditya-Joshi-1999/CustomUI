		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#studentDetailsuistudentDetailsui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"studentDetailsuistudentDetailsui-display": {
								"semanticObject": "studentDetailsuistudentDetailsui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=studentDetailsui.studentDetailsui",
									"url": sap.ui.require.toUrl("studentDetailsui/studentDetailsui")
								}
							}
						}
					}
